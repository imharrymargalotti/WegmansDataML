...
class Vision:
    ...
    def __init__(self, videoURL, tempFile, chunks):
    ...
    def get_stream(self):
        ...
        for i in range(tries):
            try:
                streams = streamlink.streams(self.videoURL)
            except:
    ...
    def dl_stream(self):
        ...
        while i <= self.chunks:
            ...
            if cur_time_stamp <= pre_time_stamp:
                ...
                file = open(self.tempFile, 'ab+')  # ab+ means keep adding to file
